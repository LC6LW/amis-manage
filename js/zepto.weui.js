...
function gallery(url, options = {}) {
    ...
    <button class="weui-hidden_abs weui-gallery__close right">鍏抽棴</button>
    <span class="weui-gallery__img" style="background-image: url(<%= url %>);" role="img" src="<%= url %>"></span>
    <div class="weui-gallery__opr">
        <a href="javascript:" class="weui-gallery__del" role="button" aria-label="鍒犻櫎">
    ...
    function _hide(callback) {
        _hide =function(){} // 闃叉浜屾璋冪敤瀵艰嚧鎶ラ敊
